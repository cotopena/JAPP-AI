...
## Inputs
- Required: ticket or plan path (e.g., `.documents/.tickets/current/TICKET-2001-refresh-hero-and-project-flow-2026-02-19.md` or `.documents/.plans/current_plan/PLAN-2001-refresh-hero-and-project-flow-2026-02-19.md`). If missing, ask the user for it before continuing.
...
- Examples:
  - `gus/feat/PLAN-2001-refresh-hero-and-project-flow-2026-02-19`
  - `gus/fix/TICKET-2002-fix-project-filter-state-2026-02-19`
...
`Use workflow/commands/make_branch.md for .documents/.plans/current_plan/PLAN-2001-refresh-hero-and-project-flow-2026-02-19.md (type=feat)`
